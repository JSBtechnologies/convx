...
The desktop app is built with [Tauri v2](https://v2.tauri.app/) and [Quasar](https://quasar.dev/). Bootstrap scripts in [`installers/`](installers/README.md) set up all required system dependencies and build the app for your platform.

```bash
# macOS
cd installers/macos && ./bootstrap.sh

# Windows (run in PowerShell as Administrator)
cd installers/windows && .\bootstrap.ps1
```

See [`installers/README.md`](installers/README.md) for full build instructions.
...
Platform-specific bootstrap scripts are available in [`installers/`](installers/README.md).
...
See the [MCP Usage wiki page](https://github.com/JSBtechnologies/convx/wiki/MCP-Usage) for detailed setup and troubleshooting.
...
See [CONTRIBUTING.md](CONTRIBUTING.md) for setup instructions, code style requirements, and how to add a new format.
