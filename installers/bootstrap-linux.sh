...
"$VENV_DIR/bin/pip" install pandas openpyxl weasyprint pdf2docx mobi
...
"$VENV_DIR/bin/python3" -c "import pandas, openpyxl, weasyprint, pdf2docx, mobi; print('Python modules OK')"
