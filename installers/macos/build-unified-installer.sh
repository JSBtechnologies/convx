...
## Ed25519 public key for license signature verification (compiled into binaries).
## Override with CONVX_LICENSE_PUBKEY env var if regenerating the keypair.
export CONVX_LICENSE_PUBKEY="${CONVX_LICENSE_PUBKEY:-3ede8773c0e82ec430310ab8fb4344562f4c4a3f5d97c41b5e48aaceccf8fc18}"
