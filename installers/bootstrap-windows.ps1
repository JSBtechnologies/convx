...
Invoke-Checked -FilePath $VenvPip -Arguments @("install", "pandas", "openpyxl", "weasyprint", "pdf2docx", "PyMuPDF==1.23.26", "mobi", "pyarrow", "numpy", "h5py") -FailureMessage "Python package install failed"
...
& $VenvPython -c "import pandas, openpyxl, weasyprint, pdf2docx, fitz, mobi, pyarrow, numpy, h5py; print('Python modules OK')" | Out-Host
